...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/26 12:09:14 by dlytvync          #+#    #+#             */
/*   Updated: 2026/02/26 12:09:15 by dlytvync         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	compute_hit(t_game *game, double angle, t_dda *dda)
{
	...
	if (game->ray.side == 0)
	{
		dist = (dda->map_x - game->player.pos_x + (1 - dda->step_x) / 2)
			/ game->ray.dir_x;
	...
	{
		dist = (dda->map_y - game->player.pos_y + (1 - dda->step_y) / 2)
			/ game->ray.dir_y;
